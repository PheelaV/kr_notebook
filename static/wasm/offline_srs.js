 ...
 * @param {string} card_state_json
 * @param {number} quality
 * @param {number} desired_retention
 * @param {boolean} focus_mode
 * @returns {string}
 */
export function calculate_next_review(card_state_json, quality, desired_retention, focus_mode) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(card_state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.calculate_next_review(ptr0, len0, quality, desired_retention, focus_mode);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function validate_answer(user_input, correct_answer, used_hint) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(user_input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(correct_answer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.validate_answer(ptr0, len0, ptr1, len1, used_hint);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('offline_srs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
